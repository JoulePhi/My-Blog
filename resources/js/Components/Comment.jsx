                ...
                <div className="w-full mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="py-2 px-4  bg-gray-50 rounded-lg rounded-t-lg border-2 border-gray-200  ">
                            <input type="email" name='email' id='email' className="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none bg-gray-50 " placeholder="Your Email" value={email} onChange={(e) => setEmail(e.target.value)} />
                        </div>
                        <div className="py-2 px-4  bg-gray-50 rounded-lg rounded-t-lg border-2 border-gray-200  ">
                            <input type="text" name='title' id='title' className="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none bg-gray-50 " placeholder="Title" value={title}
