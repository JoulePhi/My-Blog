            ...
            <section className="bg-gray-50  py-8 lg:py-16 antialiased">
                <div className="w-full mx-auto px-4">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="font-semibold text-purple text-xl mb-5">Comments (20)</h2>
                    </div>
                    <form className="mb-6">
                        ...
                        <button type="submit"
                            className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-purple rounded-lg focus:ring-4 focus:ring-purple/20  hover:bg-purple/80">
                            Post comment
                        </button>
                    </form>
                    <article className="p-6 text-base bg-gray-50 rounded-lg ">
                        <footer className="flex justify-between items-center mb-2">
                            ...
                            <button id="dropdownComment1Button" data-dropdown-toggle="dropdownComment1"
                                className="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500  bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50   "
                                type="button">
                            ...
                            <div id="dropdownComment1"
                                className="hidden z-10 w-36 bg-gray-50 rounded divide-y divide-gray-100 shadow ">
                    ...
                    <article className="p-6 mb-3 ml-6 lg:ml-12 text-base bg-gray-50 rounded-lg ">
                        <footer className="flex justify-between items-center mb-2">
                            <div className="flex items-center">
                                <p className="inline-flex items-center mr-3 text-sm text-gray-900  font-semibold"><img
                                    className="mr-2 w-6 h-6 rounded-full"
                    ...
                    <article className="p-6 mb-3 text-base bg-gray-50 border-t border-gray-200  ">
                        <footer className="flex justify-between items-center mb-2">
                            <div className="flex items-center">
                                <p className="inline-flex items-center mr-3 text-sm text-gray-900  font-semibold"><img
                                    className="mr-2 w-6 h-6 rounded-full"
