...
const Tags = ({ tags }) => {
    ...
    const currentPageData = tags.data
        .map((tag, index) => {
            return (
                <tr key={index} className='border-b py-5'>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 w-1/4 text-pretty line-clamp-3 w-full">
                        {tag.content}
                    </td>
