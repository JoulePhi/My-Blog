...
const Blogs = ({ blog, tags, categories, postTagIndexes, postCategoryIndexes }) => {
    ...
    return (
        <>
            ...
            <Link href={route('admin.posts.index')} className="text-2xl font-bold font-opensans text-slate-800 hover:underline"> {"<< Back"} </Link>
                        ...
                        {isWriting ? (
                            <>
                                ...
                                <div className='col-span-2 flex justify-end items-center'>
                                    ...
                                    <button
                                        className="bg-green text-white active:bg-green-600 text-xs font-bold uppercase px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 hover:bg-green-400"
