...
const SvgArduino = (props) => (
    ...
    >
        ...
        >
            <stop offset={0.117} stopColor="#fff" stopOpacity={0} />
            <stop offset={0.252} stopColor="#c0d1d3" stopOpacity={0.153} />
            <stop offset={0.387} stopColor="#91b3b7" stopOpacity={0.306} />
            <stop offset={0.52} stopColor="#6d9fa3" stopOpacity={0.457} />
            <stop offset={0.65} stopColor="#4d9195" stopOpacity={0.604} />
            <stop offset={0.776} stopColor="#30888b" stopOpacity={0.746} />
            <stop offset={0.895} stopColor="#148386" stopOpacity={0.881} />
            <stop offset={1} stopColor="#008184" />
        </linearGradient>
        <linearGradient
            id="arduino_svg__b"
            x1={-16.8}
        ...
        >
            ...
            <stop offset={0.153} stopColor="#c0d1d3" stopOpacity={0.153} />
            <stop offset={0.306} stopColor="#91b3b7" stopOpacity={0.306} />
            <stop offset={0.457} stopColor="#6d9fa3" stopOpacity={0.457} />
            <stop offset={0.604} stopColor="#4d9195" stopOpacity={0.604} />
            <stop offset={0.746} stopColor="#30888b" stopOpacity={0.746} />
            <stop offset={0.881} stopColor="#148386" stopOpacity={0.881} />
            <stop offset={1} stopColor="#008184" />
        </linearGradient>
        <path
            fill="url(#arduino_svg__a)"
            stroke="url(#arduino_svg__b)"
            strokeMiterlimit={10}
